      ...
      <Container className="d-flex justify-content-center align-items-center h-100">
        <Card style={{ width: '40rem' }} className="mx-2 my-2 p-4">
          <Card.Body>
            ...
            <Card.Subtitle className="mb-4 text-muted h4">This is the landing page for our application that allows users to view a live feed of MBTA as well as routes, alerts,fares and contact.</Card.Subtitle>
